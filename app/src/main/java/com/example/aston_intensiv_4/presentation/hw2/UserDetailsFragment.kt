...
import com.example.aston_intensiv_4.presentation.hw2.UserListFragment.Companion.USER_BUNDLE_KEY
...
class UserDetailsFragment : Fragment(R.layout.fragment_user_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.userImage.load(user?.imageUri ?: R.drawable.ic_user) {
            crossfade(true)
