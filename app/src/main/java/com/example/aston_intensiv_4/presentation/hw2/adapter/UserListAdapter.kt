package com.example.aston_intensiv_4.presentation.hw2.adapter
...
import com.example.aston_intensiv_4.databinding.ItemUserBinding
...
class UserListAdapter(private val onClick: (item: User) -> Unit) :
    ...
    inner class UserViewHolder(private val binding: ItemUserBinding) :
        ...
        fun bind(user: User) {
            ...
            binding.image.load(user.imageUri ?: R.drawable.ic_user) {
                crossfade(true)
